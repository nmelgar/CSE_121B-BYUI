...
let dayOutput = document.getElementById("message2")

let message;
if (day <= 5) {
    message = "Hang in there";
    dayOutput.innerHTML = day + ". " + message
    console.log(message)
} else {
...
function output(temples) {
    ...
    // let ul = '<ul id ="templeList"></ul>';
    // div.innerHTML = ul;
    // let ulElement = document.getElementById("templeList")
    ...
    temples.forEach(temple => {
        ...
        item.innerHTML = temple.templeName;
